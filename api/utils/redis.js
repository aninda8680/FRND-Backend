...
if (!isConfigured) {
  if (process.env.NODE_ENV === 'production') {
    console.error('WARNING: UPSTASH_REDIS_REST_URL or UPSTASH_REDIS_REST_TOKEN or REDIS_URL missing or invalid in production. Redis caching and rate-limiting disabled gracefully.');
  }
}
